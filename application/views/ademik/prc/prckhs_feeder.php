...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			Proses Kirim data KHS ke Feeder
		</h1>
		<ol class="breadcrumb">
			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Proses Kirim data KHS ke Feeder</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<form action="<?= base_url("ademik/prc/prckhs_feeder/import_khs_feeder_all") ?>" method="POST">
