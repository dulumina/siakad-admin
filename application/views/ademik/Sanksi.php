                    ...
                    <div class="pad">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <div class="row">
                            <button class="btn btn-warning" onclick="proc('1')">Proses</button>
                          </div>
                        </div>
                        <div class="col-6">
...
<div class="modal modal-danger fade" id="modal-danger">
  ...
  <div class="modal-content">
    ...
    <p id="msg"></p>
    <div class="col-12">
      <!-- <input type="hidden" id="nimc" name="nimc[]" value=""> -->
      <div class="form-group row">
        <label for="penanggungJawab" class="col-sm-3 col-form-label">Penanggung jawab</label>
        <div class="col-sm-9">
        <input class="form-control" type="text" id="penanggungJawabc">
        </div>
      </div>
      <div class="form-group row">
        <label for="kasus" class="col-sm-3 col-form-label">Kasus</label>
        <div class="col-sm-9">
        <input class="form-control" type="text" id="kasusc">
        </div>
      </div>
      <div class="form-group row">
        <label for="ket" class="col-sm-3 col-form-label">Keterangan</label>
        <div class="col-sm-9">
        <input class="form-control" type="text" id="ketc">
        </div>
      </div>
      <div class="form-group row">
        <label for="skSanksi" class="col-sm-3 col-form-label">SK-Sanksi</label>
        <div class="col-sm-9">
        <input class="form-control" type="text" id="skSanksic">
        </div>
      </div>
    </div>
    </div>
    ...
    <button onclick="proc('0')" type="button" class="btn btn-outline float-right">Cabut Sanksi</button>
    </div>
  </div>
  <!-- /.modal-content -->
  </div>
