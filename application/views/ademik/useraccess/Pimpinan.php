			...
			<div class="col-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Management User Pimpinan</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<a href="<?= base_url('ademik/useraccess/addPimpinan'); ?>" class="btn btn-flat btn-success" style="margin-bottom: 20px;">Tambah user Pimpinan</a>
