...
class Mhsw_model extends CI_Model {
	...
	public function get_dataTabelMhsw($KodeJurusan,$tahunAkademik){
		...
		$this->db->select('m.NIM, m.Name, m.TglLahir, m.NamaIbu, m.id_reg_pd, m.TempatLahir, d.Name as dosen, sm.Nama as statusMhsw, p.Nama_Indonesia as namaProgram, j.Nama_Indonesia as namaJurusan, j.id_sms, m.sex, m.AgamaID, m.nik, m.StatusAwal ');
