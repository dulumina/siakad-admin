...
class M_prcSiakad2 extends CI_Model {
	...
	public function getDaftarulang($where='')
	{
		...
		$query = "SELECT 	
			...
			WHERE lulus_pcmb.st_biodata = 1 and lulus_pcmb.st_siakad = 0 $where
