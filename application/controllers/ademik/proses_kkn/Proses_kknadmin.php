...
/*	public function tes(){
	...
	public function prckkn()
	{
		...
		$thn 			= $_SESSION['thn']= "20202";
		$tbl 			= $_SESSION['tbl']= "_v2_krs20202";
		$angkatan_kkn 	= $_SESSION['angkatan_kkn']= "93";

		$qMhswKkn		= $_SESSION['qMhswKkn']= $this->Kkn_modeladmin->getMhswKkn($nim);

		//$id = $qMhswKkn->ID;
		//$nama =str_replace("'", "&#39;", $qMhswKkn->nm);
		$nama = $qMhswKkn->nm;
