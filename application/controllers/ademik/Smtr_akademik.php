...
class Smtr_akademik extends CI_Controller {
	...
	public function simpan_data(){
			...
			if (!$this->db->table_exists("_v2_krs$kode")) {
				$this->Smesterakademik_model->creatTableKrs($kode);
			}
 	...
 	public function serverside_data_semester($program, $jurusan )
    {
		...
		// public function coba($tahun)
		// {
		// 	if (!$this->db->table_exists("_v2_krs$tahun")) {
		// 		$res = $this->Smesterakademik_model->creatTableKrs($tahun);
		// 		var_dump($res);
		// 	}else {
